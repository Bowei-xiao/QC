...
Rscript drawMissingRate.R ${prefix}_${plinkOri}_blankFix
...
plink1.9 --noweb --bfile ${prefix}_${plinkOri}_commonSNP --indep-pairwise 1500 100 ${r2} --out ${prefix}_${plinkOri}_commonSNPAfterPrune 
...
Rscript 1118HetCheck.R ${prefix}_${plinkOri}
...
paste 1_${plinkOri}_notUseChr.txt TMP_SNPnotON.txt > TMP_SNP1.txt
...
cat TMP_SNP1.txt TMP_SNP2.txt TMP_SNP3.txt TMP_SNP4.txt> ${plinkOri}_SNPMarkedInQC.txt


rm TMP_*
mkdir ${plinkOri}_intermediateSteps
mv [1-7]_* ${plinkOri}_intermediateSteps/
